...
//        }
    ...
    private void discoverNetworks(BlockPos pos, World world) {
        ...
        for(ConduitState peer : peers) {
            if(!networks.contains(peer.getNetwork())) networks.add(peer.getNetwork());
        }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        getNetworks(pos, world).forEach(network -> MinecraftClient.getInstance().player.addChatMessage(
